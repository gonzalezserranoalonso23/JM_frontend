    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'max-sm:inset-x-0 max-sm:bottom-[var(--app-vv-bottom-inset,0px)] max-sm:top-auto max-sm:max-h-[calc(var(--app-vh,1svh)*100-0.5rem-var(--app-vv-bottom-inset,0px))] max-sm:w-full max-sm:translate-x-0 max-sm:translate-y-0 max-sm:rounded-b-none max-sm:rounded-t-2xl max-sm:zoom-in-100 max-sm:zoom-out-100 max-sm:data-[state=open]:slide-in-from-bottom max-sm:data-[state=closed]:slide-out-to-bottom',
          className
        )}
        {...props}
      >
